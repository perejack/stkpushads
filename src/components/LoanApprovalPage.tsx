  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-6">
        ...
        {/* Survey Ad - Below the main card */}
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-4 sm:p-6 shadow-xl border-2 border-green-200">
          <div className="text-center mb-4">
            <div className="inline-block bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 py-2 rounded-full text-sm font-bold mb-3 animate-bounce">
              🎉 CELEBRATE WITH EXTRA CASH
            </div>
            <h3 className="text-lg font-bold text-gray-900 mb-2">
              Your loan is approved!
            </h3>
            <p className="text-sm text-gray-600 mb-4">
              Why not earn KES 500 more right now?
            </p>
          </div>
          <AdContainer
            placement="success-page-survey"
            variant="card"
            maxAds={1}
